...
class QuestionInsert {
  ...
  answerinsert(QuizTypeRefID,scheduleRefID,questionRefID,AnswerPick) async{
   // questionRefID=Constants.QuestionRefID;
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.questions+"."+Constants.API_BASE_URL+"/api/s1/QI/Answers":"https://uat.quizmaster.world:5001/api/s1/QI/Answers";
  ...
  answerresponsepoornetwork(scheduleRefID,questionRefID) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/qi/GetPickAnswers":"https://uat.quizmaster.world:5001/api/s1/qi/GetPickAnswers";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
