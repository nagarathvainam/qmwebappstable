...
class Question {
  ...
  Future<String> getQuestionWiseWinnerData(QuestionRefID) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.questions+"."+Constants.API_BASE_URL+"/api/s1/win/QuestionWinners":"https://uat.quizmaster.world:5001/api/s1/win/QuestionWinners";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getCorrectAnswerData(scheduleRefID) async {
   ...
   // var ScheduleRefID=prefs.getString('scheduleRefID');
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.report+"."+Constants.API_BASE_URL+"/api/s1/QI/UserWiseAnswerQuestion":"https://uat.quizmaster.world:5001/api/s1/QI/UserWiseAnswerQuestion";
  ...
  Future<String> getAnswerPercentageData(questionRefID) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.questions+"."+Constants.API_BASE_URL+"/api/s1/QI/AnswersPer":"https://uat.quizmaster.world:5001/api/s1/QI/AnswersPer";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  UserQuizPlayed() async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.report+"."+Constants.API_BASE_URL+"/api/s1/win/UserQuizPlayed":"https://uat.quizmaster.world:5001/api/s1/win/UserQuizPlayed";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getScheduleData() async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.schedule+"."+Constants.API_BASE_URL+"/api/s1/$prefix/Schedule":"https://uat.quizmaster.world:5001/api/s1/$prefix/Schedule";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getSchemeData(QuizTypeRefID) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.schedule+"."+Constants.API_BASE_URL+"/api/s1/$prefix/GetGroup":"https://uat.quizmaster.world:5001/api/s1/$prefix/GetGroup";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  QuestionSync(ScheduleRefID) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/ScheduleSync":"https://uat.quizmaster.world:5001/api/s1/$prefix/ScheduleSync";
  ...
  playvideo() async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.master+"."+Constants.API_BASE_URL+"/api/s1/master/PlayVideo":"https://uat.quizmaster.world:5001/api/s1/master/PlayVideo";
  ...
  Future<String> getScheduleWiseWinnerData(ScheduleRefID) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.schedule+"."+Constants.API_BASE_URL+"/api/s1/win/ScheduleWinners":"https://uat.quizmaster.world:5001/api/s1/win/ScheduleWinners";
