...
class SplashWebPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SplashWebPageState();
}
...
class _SplashWebPageState extends State<SplashWebPage> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network((Constants.staging_production>0)?"https://uat.quizmaster.world:5002/UploadFiles/Video/AppOpen/QMLOGOvertical.mp4":"https://uat.quizmaster.world:5002/UploadFiles/Video/AppOpen/QMLOGOvertical.mp4");//"https://uat.quizmaster.world:2018/UploadFiles/QI/Vi/QILogi.mp4"
