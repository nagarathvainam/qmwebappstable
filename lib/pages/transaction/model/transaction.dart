...
class Transactions {
  ...
  payschdule( coinAmount, checkedOverAllTotal, CrDr, scheduleRefID,
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/PaySchedule":"https://uat.quizmaster.world:5001/api/s1/$prefix/PaySchedule";
  ...
  payment(amount,mobile,email) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.pg+"."+Constants.API_BASE_URL+"/api/S1/CashFreePG/PGRequest":"https://uat.quizmaster.world:5001:2012/api/S1/CashFreePG/PGRequest";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getWithDrawData() async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/QI/ApproveWithdraw":"https://uat.quizmaster.world:5001/api/s1/QI/ApproveWithdraw";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getTransactionData(ServiceRefID,FromDate,ToDate) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/Transaction":"https://uat.quizmaster.world:5001/api/s1/$prefix/Transaction";
 ...
 var beneRefID="";
  internalApiAddBeneficiary(name,bankaccount,ifsc) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/AddBank":"https://uat.quizmaster.world:5001/api/s1/$prefix/AddBank";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
 ...
 var withdrawHead1="";
  ...
  Future<String> getMtbData(date,approvedStatusRefID) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/mtb":"https://uat.quizmaster.world:5001/api/s1/$prefix/mtb";
  ...
  internalApiRemoveBeneficiary(BeneRefID) async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/AccountDelete":"https://uat.quizmaster.world:5001/api/s1/$prefix/AccountDelete";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getBenData() async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/AccountInfo":"https://uat.quizmaster.world:5001/api/s1/$prefix/AccountInfo";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  withDrawRequest(amount) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.balance+"."+Constants.API_BASE_URL+"/api/s1/$prefix/Withdraw":"https://uat.quizmaster.world:5001/api/s1/$prefix/Withdraw";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  PayOut(transactionID, selectedBenId) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.mtb+"."+Constants.API_BASE_URL+"/api/s1/PO/PayOut":"https://uat.quizmaster.world:5001/api/s1/PO/PayOut";
  ...
  ApproveWithdraw(amount,transactionid,benid) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.trans+"."+Constants.API_BASE_URL+"/api/s1/$prefix/ApproveWithdraw":"https://uat.quizmaster.world:5001/api/s1/$prefix/ApproveWithdraw";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  PayOutUpdate(transactionID,statusCode,statusMessage) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.mtb+"."+Constants.API_BASE_URL+"/api/s1/PO/PayOutUpdate":"https://uat.quizmaster.world:5001/api/s1/PO/PayOutUpdate";
  ...
  PayinUpdate(transactionID,TransactionStatusRefID) async{
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.master+"."+Constants.API_BASE_URL+"/api/s1/PG/UpdatePGTransaction":"https://uat.quizmaster.world:5001/api/s1/PG/UpdatePGTransaction";
    var response =await http.post(Uri.parse(myUrl),
      headers: headers,
      body: body,
    );
  ...
  Future<String> getpreviousquizdata() async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.report+"."+Constants.API_BASE_URL+"/api/s1/win/OverallWinningAmountQuizCount":"https://uat.quizmaster.world:5001/api/s1/win/OverallWinningAmountQuizCount";
