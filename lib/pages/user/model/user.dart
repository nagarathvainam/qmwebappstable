...
class User {
  ...
  deviceAuth() async {
    ...
    String myUrl = (Constants.staging_production>0)?Constants.https+Constants.auth+"."+Constants.API_BASE_URL+"/api/s1/QI/AuthCheck":"http://uat.quizmaster.world/api/s1/QI/AuthCheck";
  ...
  userKycinfo() async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ? Constants.https +
            ...
            "/api/s1/Docs/Docs"
        : "http://uat.quizmaster.world/api/s1/Docs/Docs";
  ...
  balanceinfo() async {
    ...
    var response = await dio.request(
      'http://uat.quizmaster.world/api/s1/UI/GetUsersInfo',
      options: Options(
        method: 'POST',
        headers: headers,
      ),
    ...
    if (isdeo == 0) {
      ...
      String myUrl = (Constants.staging_production > 0)
          ...
          : "http://uat.quizmaster.world/api/s1/$prefix/Balance";
      var response = await http.post(
        Uri.parse(myUrl),
        headers: headers,
        body: body,
    ...
    if (qsid != '') {
     ...
     // Map<String, String> headers = {'Content-Type': 'application/json'};
      ...
      String myUrl = (Constants.staging_production > 0)
          ...
          : "http://uat.quizmaster.world/api/s1/$prefix/GetUsersInfo"; // QC OK
  ...
  passwordupdate(mobile, password) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/QI/PasswordUpdate";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  fileUpload(ImageTypeRefID, fileType, base64string) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ? Constants.https +
            ...
            Constants.API_BASE_URL +
            "/api/s1/Docs/Upload"
        : "http://uat.quizmaster.world/api/s1/Docs/Upload";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  login(mobile, password, logintype) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ? Constants.https +
            ...
            Constants.API_BASE_URL +
            "/api/s1/QI/AuthUser"
        : "http://uat.quizmaster.world/api/s1/QI/AuthUser"; // QC OK
  ...
  sendOTPLogin(mobile, otptype) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/Master/SendOTP";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  Future<String> getStateData() async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ? Constants.https +
            ...
            Constants.API_BASE_URL +
            "/api/s1/Master/State"
        : "http://uat.quizmaster.world/api/s1/master/State";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  profileupdatecreate(surName, displayName, Name, dob, GenderType, mailID,
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/$prefix/UpdateUserInfo";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  verifyOTPLogin(mobile, otp) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/Master/OTPValidate";
  ...
  forgotPin(mobile, password) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/$prefix/PasswordUpdate";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  getScheduleOverallHistory() async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/win/OverAllWinningQuizCount";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  blockdetailinfo(MobileNo) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/$prefix/BlockStatus";
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
      body: body,
  ...
  userRedeem(referalCode) async {
    ...
    String myUrl = (Constants.staging_production > 0)
        ...
        : "http://uat.quizmaster.world/api/s1/QI/UpdateUserInfo";
    Constants.printMsg("myUrl:$myUrl");
    var response = await http.post(
      Uri.parse(myUrl),
      headers: headers,
