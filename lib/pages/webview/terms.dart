                          ...
                          children:  <Widget>[
                            Row(
                              children:  <Widget>[
                                ...
                                SizedBox(width: 10.0,),
                                Expanded(
                                  child: Text('QUIZ MASTER PRIVATE LTD DOES NOT WARRANT THAT THIS PORTAL, IT’S SERVERS, OR EMAIL SENT BY US OR ON OUR BEHALF ARE VIRUS FREE. QUIZ MASTER PRIVATE LTD WILL NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND ARISING FROM THE USE OF THIS PORTAL, INCLUDING, BUT NOT LIMITED TO COMPENSATORY, DIRECT, INDIRECT, INCIDENTAL, PUNITIVE, SPECIAL AND CONSEQUENTIAL DAMAGES, LOSS OF DATA, GOODWILL, BUSINESS OPPORTUNITY, INCOME OR PROFIT, LOSS OF OR DAMAGE TO PROPERTY AND CLAIMS OF THIRD PARTIES. IN NO EVENT WILL QUIZ MASTER PRIVATE LTD BE LIABLE FOR ANY DAMAGES WHATSOEVER ', textAlign: TextAlign.justify,style: TextStyle(fontSize: 16),),
                                )
                              ],
                            ),
