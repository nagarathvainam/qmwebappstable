...
class TransactionHistory extends StatefulWidget {
  String page;
  TransactionHistory({required this.page});
  @override
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            appBar:  TransactionAppBar(
              ...
              page: (widget.page=='All')?'All Transactions':"Withdraw History",
            ),
            body:SafeArea(
                      ...
                      Table(
                        ...
                        children: [
                          TableRow( children: [
                            ...
                            Column(children:[Padding(padding:  EdgeInsets.only(bottom: 0 ,left: 6,top: 8), child:Text('Amout',
                              style: SafeGoogleFont (
                                'Open Sans',
                                fontSize: 16*ffem,
                                fontWeight: FontWeight.w700,
                            ...
                            Column(children:[Padding(padding:  EdgeInsets.only(bottom: 0 ,left: 6,top: 8), child:Text('Previous ',
                              style: SafeGoogleFont (
                                'Open Sans',
                                fontSize: 16*ffem,
                                fontWeight: FontWeight.w700,
                          ...
                          for(int index = 0; index<transactiondata.length;index++)...[
                            TableRow( children: [
                              Column(children:[Padding(padding:  EdgeInsets.only(bottom: 5 ,left: 12,top: 5), child:Text(transactiondata[index]['createdDate']))]),
                              Column(children:[
